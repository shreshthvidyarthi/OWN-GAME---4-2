class Form{
    ...
    display() {
        ...
        this.description.html("DESCRIPTION - THE CITY IS IN THREAT WITH ALL THE CITIZENS LOOKING FOR A HERO TO SAVE THEM ,  KILL THE VIRUS USING MASK/SANITIZER AND SAVE THE CITIZENS BEFORE ITS TOO LATE , U HAVE 30 LIFES TO SAVE AND PRESSURE OF GAINING 1500 POINTS AT THE SAME TIME, HINT:try to outscore your enemy by attemting to kill all the enemy cells visible ;) RISKING = WINNING... GOOD LUCK  :)")
